...
observeEvent(input$stm_go,{
  ...
  renderPrint({
    ...
    if (ncountry == 1) {
      stm_formula <- ~ DQ1.Age + EntryDate + DQ3.Education + DQ2.Gender + Q7.Score
    ...
    stm_model <- stm(docs, vocab, 12, prevalence = stm_formula,  data = meta, init.type = "Spectral", max.em.its = 700)
    })
  })
})
```
