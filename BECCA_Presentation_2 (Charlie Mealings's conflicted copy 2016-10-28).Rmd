...
renderUI({
  ...
  source("sort_signifiers.R")
  sigtypes(stm_dataset, unpack = TRUE)
...
```{r, echo=FALSE}
observe({
  req(stm.values$meta, stm.values$stm.model)
  stmBrowser_widget(stm.values$stm.model, data=stm.values$meta, c("EntryDate","DQ1.Age","DQ3.Education", "DQ2.Gender", "Q7.Score"),text="texts_eng", labeltype='frex') 
})
```
